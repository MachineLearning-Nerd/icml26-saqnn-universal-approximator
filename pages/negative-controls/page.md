...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_f9560d1df64f", "created_at": "2026-07-20T10:12:30+00:00", "title": "Scope controls"}
-->
Controls reject the omitted nonnegative target range, treating the circuit-size comparison as uniform in accuracy, and treating the source uniform n display as an optimal fixed-d rate. These controls distinguish a valid source-scoped result from a broader metadata claim.


---
<!-- trackio-cell
{"type": "code", "id": "cell_7a61198e77e7", "created_at": "2026-07-20T10:12:40+00:00", "title": "Source-pinned full audit", "command": ["python", "repro/src/full_audit.py", "--source-dir", "docs/source", "--output", "outputs/full_audit.json"], "exit_code": 0, "duration_s": 0.079}
-->
````bash
...
````json title=full_audit.json
{
  ...
  "claims": {
    "claim_1_universal_approximation": {
      "live_claim_outcome": "falsified_as_written_range_omitted",
      "maximum_source_amplitude_construction_error": 4.440892098500626e-16,
      "minimum_restricted_target_value": 0.28284531859642115,
      "negative_constant_counterexample_nonnegative_output_lower_bound": 0.25,
      "pass": true,
      "restricted_nonnegative_finite_fourier_cells": 6144,
      "signed_l2_counterexample": "sin(x)",
      "signed_l2_counterexample_nonnegative_output_lower_bound": 0.5,
      "source_theorem_scope": "[0,1]-valued L2 targets with positive a=sum_r |c_r|"
    },
    "claim_2_circuit_size_advantage": {
      "fixed_accuracy_high_dimension_cells": 27,
      "high_accuracy_fixed_dimension_control": {
        "dimension": 2,
        "epsilon": 0.001,
        "log_classical_size": 6.210693239105087,
        "log_saqnn_size": 110579.27906218462,
        "rejected_unqualified_all_regime_advantage": true,
        "smoothness": 2.0
      },
      "minimum_log_classical_size_minus_log_saqnn_size": 172203.06501151403,
      "pass": true,
      "scope": "Fixed epsilon and sufficiently large dimension; the source comparison is not uniform in accuracy.",
      "source_resource_model": "SAQNN n log(n)^2 versus displayed ReLU-FNN circuit-size expression",
      "verdict": "verified_for_source_fixed_accuracy_high_dimension_comparison"
    },
    "claim_3_parameter_optimality": {
      "case_four_parameter_exponent": "d/s in log N versus log(1/epsilon)",
      "fixed_dimension_high_accuracy_rate_cells": 36,
      "maximum_case_four_log_parameter_slope_error": 2.220446049250313e-15,
      "nwidth_lower_bound_exponent": "d/s",
      "pass": true,
      "scope": "Fixed d and epsilon -> 0, where the source Case-4 Fourier construction has the n-width exponent d/s.",
      "uniform_display_control_rejected_as_optimal_fixed_d_rate": true,
      "uniform_display_nonoptimality_control_log_gaps": [
        113.28631166947562,
        292.65145036155803,
        737.1625812991783
      ],
  ...
  "source": {
    ...
    "source_anchors": [
      "case_4_rate",
      "fixed_accuracy_high_dimension_scope",
      "fourier_nwidth_rate",
      "positive_rescale_proof",
      "theorem_1_observable",
      "theorem_1_range",
      "theorem_2_resource_formula",
      "theorem_2_sobolev_range"
    ],
